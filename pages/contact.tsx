  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-between bg-background">
      ...
      <div className="py-16 md:py-24 px-4 w-full max-w-5xl mx-auto">
        <h1 className="text-4xl md:text-6xl font-bold my-8 mb-4 text-center text-foreground">Contact Us</h1>
        <p className="text-center mb-12 text-lg text-muted-foreground font-medium">
          Have questions about our workshops or want to book MCM for your school? Reach out to us on Instagram!
        </p>
        <ContactForm />
        <div className="flex flex-col items-center mt-20 mb-20">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-foreground">Connect With Us</h2>
          <div className="flex flex-wrap justify-center">
            <a href="https://www.instagram.com/making.cents.of.math/" target="_blank" rel="noopener noreferrer">
