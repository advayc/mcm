        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 p-8 rounded-lg mb-8">
            ...
            <ul className="space-y-3 text-lg text-muted-foreground">
              <li className="flex items-start"><span className="text-blue-600 mr-2 font-bold">✓</span>Help facilitate <span className="font-bold">interactive workshop activities</span></li>
              <li className="flex items-start"><span className="text-blue-600 mr-2 font-bold">✓</span>Work directly with <span className="font-bold">elementary and middle school students</span></li>
              ...
              <li className="flex items-start"><span className="text-blue-600 mr-2 font-bold">✓</span>Build <span className="font-bold">leadership and communication skills</span></li>
            </ul>
          </div>
