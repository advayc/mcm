    ...
    <main className="flex flex-col items-center justify-center bg-background">
      ...
      <div className="w-full bg-gray-50 py-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-card border border-border p-8 rounded-lg hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
      ...
      <div className="w-full py-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-8">
            <div className="bg-card border border-border p-8 rounded-lg border-l-4 border-l-blue-600 hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg border-l-4 border-l-blue-600 hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-black">Lesson 2: Basic Financial Math Models</h3>
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg border-l-4 border-l-blue-600 hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-black">Lesson 3: Debt Management</h3>
              <p className="text-lg text-gray-600 mb-4">
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg border-l-4 border-l-blue-600 hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-black">Lesson 4: Investments</h3>
              <p className="text-lg text-gray-600 mb-4">
            ...
            <div className="bg-white border border-gray-200 p-8 rounded-lg border-l-4 border-l-blue-600 hover:shadow-lg hover:border-blue-300 transition-all duration-300 hover:-translate-y-1">
              <h3 className="text-2xl font-bold mb-4 text-black">Lesson 5: Financial Abuse</h3>
              <p className="text-lg text-gray-600 mb-4">
      ...
      <div className="w-full bg-secondary py-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-card border border-border p-6 rounded-lg hover:shadow-md hover:border-blue-300 transition-all duration-200 hover:-translate-y-1">
      ...
      <div className="w-full py-16 px-4 md:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a 
            href="/get-involved"
            className="inline-block font-medium px-10 py-3 bg-blue-600 text-white text-lg rounded-lg hover:bg-blue-700 hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg"
          >
            Get Involved
          </a>
        </div>
