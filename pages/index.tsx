        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center space-y-6">
            <div className="inline-block">
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-secondary text-primary rounded-full text-sm font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
              <button onClick={handleScroll} className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-medium text-lg hover:bg-primary/90 hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
                Learn More
              </button>
              <Link href="/get-involved">
                <button className="px-8 py-3 border-2 border-primary text-primary rounded-lg font-medium text-lg hover:bg-secondary hover:scale-105 transition-all duration-200">
                  Get Involved
                </button>
              </Link>
            </div>
      ...
      <section id="mission" className="py-20 px-4 bg-secondary">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-card border border-border rounded-lg p-8 hover:shadow-lg hover:border-primary/50 transition-all duration-300 hover:-translate-y-1">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-card border border-border rounded-lg p-6 hover:shadow-md hover:border-primary/50 transition-all duration-200 hover:-translate-y-1">
          ...
          <div className="mt-12 text-center">
            <Link href="/workshops">
              <button className="px-8 py-3 bg-primary text-primary-foreground rounded-lg font-medium hover:bg-primary/90 hover:scale-105 transition-all duration-200 shadow-md hover:shadow-lg">
      ...
      <section className="py-20 px-4 bg-secondary">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-card border border-border rounded-lg p-8 text-center hover:shadow-lg hover:border-primary/50 transition-all duration-300 hover:-translate-y-2">
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/team">
              <button className="px-8 py-3 border-2 border-primary text-primary rounded-lg font-medium hover:bg-secondary hover:scale-105 transition-all duration-200">
                Meet the Team
              </button>
            </Link>
          </div>
