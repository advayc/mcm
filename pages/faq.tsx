  ...
  return (
    <main className="min-h-screen items-center justify-between bg-background">
      ...
      <header className="pt-16 md:pt-24 px-4 w-full max-w-4xl mx-auto">
        <h1 className="text-2xl md:text-4xl font-bold mt-8 mb-1 text-center text-foreground">
          Frequently Asked Questions
        </h1>
        <h2 className="text-center text-lg md:text-lg font-medium text-muted-foreground mb-12">
