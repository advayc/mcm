export const faqData = {
  faqs: [
    ...
    },
    {
      ...
      answer:
        "All Making Cents of Math workshops are <strong>100% FREE</strong> for schools and students! We believe financial literacy education should be accessible to everyone, and we don't charge any fees for our workshops or materials.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Follow us on <a class='hyperlink' href='https://www.instagram.com/makingcentsofmath/' target='_blank'>Instagram</a> for workshop announcements, educational content, and updates. You can also check our <a class='hyperlink' href='/events' target='_blank'>Events</a> page for upcoming workshops in your area.",
    },
    {
      question: "How can students or parents get more involved?",
      answer:
        "We welcome students who want to volunteer as workshop facilitators or help with educational content development. Parents and community members interested in supporting financial literacy education are also welcome to get involved. Visit our <a class='hyperlink' href='/get-involved' target='_blank'>Get Involved</a> page to learn more about volunteer opportunities.",
    },
  ],
};
